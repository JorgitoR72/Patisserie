 ...
 <div class="container position-relative">
  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #8d4925; position: relative; z-index: 1; margin-top: 100px;">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="registro.html" style="color: #f1dcc2;"><strong> ACCEDER </strong><img src="img/icono_chef.png"
                alt="" style="height: 30px; width: 30px; "></a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row" id="sobre-nosotros" style="padding: 10px;">
      <div class="col-xl-6 col-md-12" style="background-color: #8d4925; height: auto; padding:20px;">
      ...
      <div class="col-xl-6 col-md-6 order-2" style="padding: 0;">
        <img src="img/historiaEmpresa.jpg" alt="Historia Empresa" class="img-fluid">
      </div>
    </div>
    <div class="row" id="sobre-nosotros" style="padding: 10px;">
      <div class="col-xl-6 col-md-12 order-1" style="background-color: #8d4925; height: auto; padding:20px;">
        <h1>NUESTRA MISIÓN</h1>
        <p>Nuestra misión es inspirar y facilitar la preparación de comidas deliciosas y nutritivas en los hogares de
          todo el mundo. Nos esforzamos por ofrecer una amplia variedad de recetas para todos los gustos y necesidades,
          desde platos rápidos y fáciles para la vida diaria hasta comidas más elaboradas para ocasiones especiales.
          Además, estamos comprometidos con la promoción de una alimentación saludable y sostenible. En resumen, nuestra
          misión es ser la mejor página de recetas de pastelería en línea, ayudando a las personas a disfrutar de la
          comida casera de una manera fácil, saludable y deliciosa.</p>
      </div>
      <div class="col-xl-6 col-md-12" style="padding: 0;">
        <img src="img/nuestraMision.webp" alt="Historia Empresa" class="img-fluid">
      </div>
    </div>
    <div class="row" id="sobre-nosotros" style="padding: 10px;">
      <div class="col-xl-6 col-md-6" style="background-color: #8d4925; height: auto; padding:20px;">
        <h1>METAS DE FUTURO</h1>
        <p>Tenemos dos principales metas de futuro una es Incorporar opciones de compras: Ofrecer opciones para comprar
          los ingredientes necesarios para las recetas directamente desde la página, así como recomendaciones de
          utensilios y equipos de cocina. Y la otra meta es Incluir opciones de interacción social: Permitir a los
          usuarios compartir sus propias recetas o modificar las existentes, intercambiar ideas y consejos de cocina, y
          calificar y comentar sobre las recetas.</p>
      </div>
      <div class="col-xl-6 col-md-6" style="padding: 0;">
        <img src="img/metasDeFuturo.webp" alt="Historia Empresa" class="img-fluid">
      </div>
    </div>
  </div>
